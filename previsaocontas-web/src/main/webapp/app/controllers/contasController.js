angular.module('app.controllers', []).controller('contasController', function($scope, $http, $timeout, $q, $rootScope, contasService) {
	...
	function resumoContas() {
		...
		contasService.resumoContas($scope.mes, $scope.ano, $scope.contas).then(function successCallback(response) {
			msgSucesso(response);
