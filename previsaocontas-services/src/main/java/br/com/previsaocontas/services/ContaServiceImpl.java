...
public class ContaServiceImpl {
	...
	if (UtilObjeto.isNull(conta.getQtde_parcelas())) {
    ...
    public List<Conta> buscaContaMes(Integer mesSelecionado, Integer anoSelecionado, Usuario usuario) throws WarningException, ErrorException {
